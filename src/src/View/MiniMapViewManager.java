...
public class MiniMapViewManager {
        ...
        gameLoop = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (curBase != game.getBase().getBaseStatus()){
                    curBase = game.getBase().getBaseStatus();
                    curBaseLabel.setText("CURRENT BASE\n\n" + baseStatusToString());
    ...
    private void buildUI(){
        ...
        try{
            curDayLabel.setFont(Font.loadFont(new FileInputStream("src/View/Resources/ARCADECLASSIC.TTF"), 15));
        } catch (FileNotFoundException e) {
            System.out.print("Font not found");
            curDayLabel.setFont(Font.getDefault());
        }

        Label dayNightLabel = new Label("\t\t\t\tSteps Remaining");
        dayNightLabel.setLayoutX(40);
        dayNightLabel.setLayoutY(300);

        try{
            dayNightLabel.setFont(Font.loadFont(new FileInputStream("src/View/Resources/ARCADECLASSIC.TTF"), 13));
        } catch (FileNotFoundException e) {
            System.out.print("Font not found");
            dayNightLabel.setFont(Font.getDefault());
        }
        ...
        try{
            curStepsLabel.setFont(Font.loadFont(new FileInputStream("src/View/Resources/ARCADECLASSIC.TTF"), 13));
        } catch (FileNotFoundException e) {
            System.out.print("Font not found");
            curStepsLabel.setFont(Font.getDefault());
        }
        ...
        Label HPLabel = new Label("\t\t\t\t\tof\t" + game.getPlayer().getMAX_HIT_POINTS() + "\tHP");
        HPLabel.setLayoutX(30);
        HPLabel.setLayoutY(370);

        try{
            HPLabel.setFont(Font.loadFont(new FileInputStream("src/View/Resources/ARCADECLASSIC.TTF"), 15));
        } catch (FileNotFoundException e) {
            System.out.print("Font not found");
            HPLabel.setFont(Font.getDefault());
        }
        ...
        try{
            curHPLabel.setFont(Font.loadFont(new FileInputStream("src/View/Resources/ARCADECLASSIC.TTF"), 15));
        } catch (FileNotFoundException e) {
            System.out.print("Font not found");
            curHPLabel.setFont(Font.getDefault());
        }

        curBaseLabel = new Label("CURRENT BASE\n\n" + baseStatusToString());
        curBaseLabel.setLayoutX(32);
        curBaseLabel.setLayoutY(450);

        try{
            curBaseLabel.setFont(Font.loadFont(new FileInputStream("src/View/Resources/ARCADECLASSIC.TTF"), 15));
        } catch (FileNotFoundException e) {
            System.out.print("Font not found");
            curBaseLabel.setFont(Font.getDefault());
        }
